...
class TreeView : public CView
{
	...
	// Construction
public:
	class VariableButton : CButton
	{//
	public:
		//If Zero, is link button; Otherwise refers to index of target node
		...
		short NodeType;
		VariableButton(unsigned int targetIndex)
		{
	...
	class LinkedButton : CButton
	{
	public:
		//Refers to index of target node linked
		unsigned int NodeKey;
		LinkedButton(unsigned int nodeKey)
		{
			NodeKey = nodeKey;
		}
		LinkedButton()
	...
	class NodeButton : CButton
	{
	public:
		//Refers to index of target node
		unsigned int NodeKey;
		LinkedButton(unsigned int nodeKey)
		{
			NodeKey = nodeKey;
	...
	public:
		...
		BasicDataNode(std::string name, int nodeKey)
		{
			nButton.NodeKey = nodeKey;
		}
		...
		/// </summary>
		/// <param name="name">The NodeName.</param>
		BasicDataNode(std::string name, short nodeType, int nodeKey)
		{
			nButton.NodeKey = nodeKey;
		}
